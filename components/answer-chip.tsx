...
export function AnswerChip({ game }: AnswerChipProps) {
  ...
  return (
    <Badge
      className="inline-flex h-8 min-w-[68px] items-center justify-center gap-1.5 px-3 rounded-md border border-muted-foreground/20 text-xs font-medium text-foreground bg-transparent"
